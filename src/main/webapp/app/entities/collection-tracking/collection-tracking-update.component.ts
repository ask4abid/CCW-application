...
export class CollectionTrackingUpdateComponent implements OnInit {
  ...
  updateForm(collectionTracking: ICollectionTracking): void {
    this.editForm.patchValue({
      ...
      extraColumnOne: collectionTracking.extraColumnOne,
      extraColumnTwo: collectionTracking.extraColumnTwo,
      extraColumnThree: collectionTracking.extraColumnThree,
      extraColumnFour: collectionTracking.extraColumnFour,
      extraColumnFive: collectionTracking.extraColumnFive,
    });
  }
  ...
  private createFromForm(): ICollectionTracking {
    return {
      ...
      extraColumnOne: this.editForm.get(['extraColumnOne'])!.value,
      extraColumnTwo: this.editForm.get(['extraColumnTwo'])!.value,
      extraColumnThree: this.editForm.get(['extraColumnThree'])!.value,
      extraColumnFour: this.editForm.get(['extraColumnFour'])!.value,
      extraColumnFive: this.editForm.get(['extraColumnFive'])!.value,
    };
  }
