...
public class CollectionTracking implements Serializable {
    ...
    @Column(name = "extra_column_one")
    private String extraColumnOne;

    @Column(name = "extra_column_two")
    private String extraColumnTwo;

    @Column(name = "extra_column_three")
    private String extraColumnThree;

    @Column(name = "extra_column_four")
    private String extraColumnFour;

    @Column(name = "extra_column_five")
    private String extraColumnFive;
    ...
    public String getExtraColumnOne() {
        return extraColumnOne;
    }

    public CollectionTracking extraColumnOne(String extraColumnOne) {
        this.extraColumnOne = extraColumnOne;
        return this;
    }

    public void setExtraColumnOne(String extraColumnOne) {
        this.extraColumnOne = extraColumnOne;
    }

    public String getExtraColumnTwo() {
        return extraColumnTwo;
    }

    public CollectionTracking extraColumnTwo(String extraColumnTwo) {
        this.extraColumnTwo = extraColumnTwo;
        return this;
    }

    public void setExtraColumnTwo(String extraColumnTwo) {
        this.extraColumnTwo = extraColumnTwo;
    }

    public String getExtraColumnThree() {
        return extraColumnThree;
    }

    public CollectionTracking extraColumnThree(String extraColumnThree) {
        this.extraColumnThree = extraColumnThree;
        return this;
    }

    public void setExtraColumnThree(String extraColumnThree) {
        this.extraColumnThree = extraColumnThree;
    }

    public String getExtraColumnFour() {
        return extraColumnFour;
    }

    public CollectionTracking extraColumnFour(String extraColumnFour) {
        this.extraColumnFour = extraColumnFour;
        return this;
    }

    public void setExtraColumnFour(String extraColumnFour) {
        this.extraColumnFour = extraColumnFour;
    }

    public String getExtraColumnFive() {
        return extraColumnFive;
    }

    public CollectionTracking extraColumnFive(String extraColumnFive) {
        this.extraColumnFive = extraColumnFive;
        return this;
    }

    public void setExtraColumnFive(String extraColumnFive) {
        this.extraColumnFive = extraColumnFive;
    }
    ...
    public String toString() {
        return "CollectionTracking{" +
            ...
            ", pptDate='" + getPptDate() + "'" +
            ", remakrs='" + getRemakrs() + "'" +
            ", extraColumnOne='" + getExtraColumnOne() + "'" +
            ", extraColumnTwo='" + getExtraColumnTwo() + "'" +
            ", extraColumnThree='" + getExtraColumnThree() + "'" +
            ", extraColumnFour='" + getExtraColumnFour() + "'" +
