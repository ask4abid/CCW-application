...
public class CollectionTrackingResourceIT {
    ...
    private static final String DEFAULT_EXTRA_COLUMN_ONE = "AAAAAAAAAA";
    private static final String UPDATED_EXTRA_COLUMN_ONE = "BBBBBBBBBB";

    private static final String DEFAULT_EXTRA_COLUMN_TWO = "AAAAAAAAAA";
    private static final String UPDATED_EXTRA_COLUMN_TWO = "BBBBBBBBBB";

    private static final String DEFAULT_EXTRA_COLUMN_THREE = "AAAAAAAAAA";
    private static final String UPDATED_EXTRA_COLUMN_THREE = "BBBBBBBBBB";

    private static final String DEFAULT_EXTRA_COLUMN_FOUR = "AAAAAAAAAA";
    private static final String UPDATED_EXTRA_COLUMN_FOUR = "BBBBBBBBBB";

    private static final String DEFAULT_EXTRA_COLUMN_FIVE = "AAAAAAAAAA";
    private static final String UPDATED_EXTRA_COLUMN_FIVE = "BBBBBBBBBB";
    ...
    public static CollectionTracking createEntity(EntityManager em) {
        CollectionTracking collectionTracking = new CollectionTracking()
            ...
            .extraColumnOne(DEFAULT_EXTRA_COLUMN_ONE)
            .extraColumnTwo(DEFAULT_EXTRA_COLUMN_TWO)
            .extraColumnThree(DEFAULT_EXTRA_COLUMN_THREE)
            .extraColumnFour(DEFAULT_EXTRA_COLUMN_FOUR)
            .extraColumnFive(DEFAULT_EXTRA_COLUMN_FIVE);
    ...
    public static CollectionTracking createUpdatedEntity(EntityManager em) {
        CollectionTracking collectionTracking = new CollectionTracking()
            ...
            .extraColumnOne(UPDATED_EXTRA_COLUMN_ONE)
            .extraColumnTwo(UPDATED_EXTRA_COLUMN_TWO)
            .extraColumnThree(UPDATED_EXTRA_COLUMN_THREE)
            .extraColumnFour(UPDATED_EXTRA_COLUMN_FOUR)
            .extraColumnFive(UPDATED_EXTRA_COLUMN_FIVE);
        return collectionTracking;
    }
    ...
    public void createCollectionTracking() throws Exception {
        ...
        assertThat(testCollectionTracking.getExtraColumnOne()).isEqualTo(DEFAULT_EXTRA_COLUMN_ONE);
        assertThat(testCollectionTracking.getExtraColumnTwo()).isEqualTo(DEFAULT_EXTRA_COLUMN_TWO);
        assertThat(testCollectionTracking.getExtraColumnThree()).isEqualTo(DEFAULT_EXTRA_COLUMN_THREE);
        assertThat(testCollectionTracking.getExtraColumnFour()).isEqualTo(DEFAULT_EXTRA_COLUMN_FOUR);
        assertThat(testCollectionTracking.getExtraColumnFive()).isEqualTo(DEFAULT_EXTRA_COLUMN_FIVE);
    }
    ...
    public void getAllCollectionTrackings() throws Exception {
        ...
        restCollectionTrackingMockMvc
            ...
            .andExpect(jsonPath("$.[*].extraColumnOne").value(hasItem(DEFAULT_EXTRA_COLUMN_ONE)))
            .andExpect(jsonPath("$.[*].extraColumnTwo").value(hasItem(DEFAULT_EXTRA_COLUMN_TWO)))
            .andExpect(jsonPath("$.[*].extraColumnThree").value(hasItem(DEFAULT_EXTRA_COLUMN_THREE)))
            .andExpect(jsonPath("$.[*].extraColumnFour").value(hasItem(DEFAULT_EXTRA_COLUMN_FOUR)))
            .andExpect(jsonPath("$.[*].extraColumnFive").value(hasItem(DEFAULT_EXTRA_COLUMN_FIVE)));
    }
    ...
    public void getCollectionTracking() throws Exception {
        ...
        restCollectionTrackingMockMvc
            ...
            .andExpect(jsonPath("$.extraColumnOne").value(DEFAULT_EXTRA_COLUMN_ONE))
            .andExpect(jsonPath("$.extraColumnTwo").value(DEFAULT_EXTRA_COLUMN_TWO))
            .andExpect(jsonPath("$.extraColumnThree").value(DEFAULT_EXTRA_COLUMN_THREE))
            .andExpect(jsonPath("$.extraColumnFour").value(DEFAULT_EXTRA_COLUMN_FOUR))
            .andExpect(jsonPath("$.extraColumnFive").value(DEFAULT_EXTRA_COLUMN_FIVE));
    }
    ...
    public void updateCollectionTracking() throws Exception {
        ...
        assertThat(testCollectionTracking.getExtraColumnOne()).isEqualTo(UPDATED_EXTRA_COLUMN_ONE);
        assertThat(testCollectionTracking.getExtraColumnTwo()).isEqualTo(UPDATED_EXTRA_COLUMN_TWO);
        assertThat(testCollectionTracking.getExtraColumnThree()).isEqualTo(UPDATED_EXTRA_COLUMN_THREE);
        assertThat(testCollectionTracking.getExtraColumnFour()).isEqualTo(UPDATED_EXTRA_COLUMN_FOUR);
        assertThat(testCollectionTracking.getExtraColumnFive()).isEqualTo(UPDATED_EXTRA_COLUMN_FIVE);
    }
